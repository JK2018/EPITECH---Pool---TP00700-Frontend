...
<div class="sidebar">
    ...
    <div class="user-menu">
        <div class="icon-btn">
            ...
            <BtnCustom v-if="role == 1 || role == 2" link="/app/reports" icon-name="las la-chart-bar" text-name="Reports" v-bind:class="getClass('/app/reports')"></BtnCustom>
            <BtnCustom v-if="role == 1 || role == 2" link="/app/user-list" icon-name="las la-user-friends" text-name="Userlist" v-bind:class="getClass('/app/user-list')"></BtnCustom>
