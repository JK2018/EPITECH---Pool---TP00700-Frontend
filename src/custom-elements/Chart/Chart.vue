...
<div>
    <div v-if="this.dataReady">
        <vue-frappe id="test" :labels="['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi']" title="" type="axis-mixed" :height="300" :colors="['purple', '#ffa3ef', 'light-blue']" :dataSets="this.toto.datasets" :tooltipOptions="this.toto.tooltipOptions">
        </vue-frappe>
    </div>
